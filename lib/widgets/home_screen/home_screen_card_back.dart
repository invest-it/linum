...
class HomeScreenCardBack extends StatefulWidget {
  final HomeScreenCardData data;
  final FlipCardController flipCardController;
  const HomeScreenCardBack({Key? key, required this.data, required this.flipCardController}) : super(key: key);

  @override
  State<HomeScreenCardBack> createState() => _HomeScreenCardBackState();
}

class _HomeScreenCardBackState extends State<HomeScreenCardBack> {
