...
def translate(diffs: dict[str, str], target_lang: str, source_lang: str, translator: deepl.Translator) -> dict[str, str]:
...
def add_translations_to_file(translations: dict[str, str], removed_translations: list[str], file_path: str, l_code: str):
...
parser.add_argument("-d", "--dir", nargs='?', const="lang", default="lang", type=str, help="directory for language files")
parser.add_argument("-b", "--base", nargs='?', const="base.json", default="base.json", type=str, help="File that is contains new tags")
parser.add_argument("-c", "--compare", nargs='?', const="de-DE.json", default="de-DE.json", type=str, help="File the base file gets compared to")
parser.add_argument("-s", "--single", nargs='?', const=False, default=False, type=bool, help="Only update the compared file")
